...
<!--			<div class="table-body">-->
				<ol>
					<li>
						...
						<textarea class="input w100" rows="3" readonly="readonly"><?php echo html_escape(element('member_register_policy1', $view)); ?></textarea>
<!--						<div class="checkbox">-->
                        <input type="checkbox" name="agree" id="agree" value="1" />
							<label for="agree" class="check-b">회원가입약관의 내용에 동의합니다.</label>
...
<!--						</div>-->
					...
					<li class="mt20">
						...
						<textarea class="input w100" rows="3" readonly="readonly"><?php echo html_escape(element('member_register_policy2', $view)); ?></textarea>
<!--						<div class="checkbox">-->
                        <input type="checkbox" name="agree2" id="agree2" value="1" />
							<label for="agree2" class="check-b">개인정보취급방침안내의 내용에 동의합니다.</label>
