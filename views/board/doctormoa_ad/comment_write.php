...
<!--    </div>-->
	<div id="comment_write_box">
        ...
        ?>
            ...
            ?>
            <div class="qt-box">
                <input type="text" name="cmt_content" id="cmt_content"  accesskey="c" placeholder="질문하기" class="" value="<?php echo set_value('cmt_content', element('cmt_content', element('comment', $view))); ?>"  <?php if ( ! element('can_comment_write', element('comment', $view))) {echo 'onClick="alert(\'' . html_escape(element('can_comment_write_message', element('comment', $view))) . '\');return false;"';} ?>>
                <button type="button" class="s-blue-btn " id="cmt_btn_submit" onClick="<?php if ( ! element('can_comment_write', element('comment', $view))) {echo 'alert(\'' . html_escape(element('can_comment_write_message', element('comment', $view))) . '\');return false;"';} else { ?>add_comment(this.form, '<?php echo element('post_id', element('post', $view)); ?>');<?php } ?> ">작성하기</button>
            </div>

            <div class="comment_write_button_area hidden">
