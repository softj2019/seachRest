...
<div class="in-box sign-box">
    <div class="content-box">
        ...
        ?>
            <p class="blue-txt mb50">패스워드 변경</p>
            ...
            <ol class="change_password">
                ...
                <li>
                    <span>새로운 패스워드</span>
                    <input type="password" name="new_password" id="new_password" class="input-1 w100" placeholder="Password" />
                </li>
                <li>
                    <span>새로운 패스워드(재입력)</span>
                    <input type="password" name="new_password_re" id="new_password_re" class="input-1 w100" placeholder="Password" />
                </li>
                <li>
                    <span></span>
                    <button type="submit" class="blue-b-btn mt80">패스워드 변경하기</button>
                </li>
            </ol>
        <?php
            echo form_close();
