		...
		?>
			...
			<div class="product-option">
				<table class="table table-bordered item_detail_table">
					<tbody>
						<tr class="thead-tr">
							<th><label for="chk_all_item"   class="check-b">옵션</label></th>
						...
						?>
							<tr>
								<td><label for="chk_detail_<?php echo element('cde_id', $detail); ?>"   class="check-b"><?php echo html_escape(element('cde_title', $detail)); ?></label></td>
								<td><input type="checkbox" name="chk_detail[]" value="<?php echo element('cde_id', $detail); ?>" id="chk_detail_<?php echo element('cde_id', $detail); ?>"/></td>
								<td>
									<div class="btn-group" role="group" aria-label="...">
										<button type="button" class="btn btn-change-qty" data-change-type="minus">-</button>
										<input type="text" name="detail_qty[<?php echo element('cde_id', $detail); ?>]" class="detail_qty" value="1" />
										<button type="button" class="btn btn-change-qty" data-change-type="plus">+</button>
									</div>
								</td>
						...
						<tr>
							<td>총금액</td>
							<td></td>
							<td colspan="2" class="cart_total_price"><span id="total_order_price">0</span>원</td>
						</tr>
					</tbody>
				</table>
			</div>
			<div class="buybtnbox">
				<button type="submit" onClick="$('#stype').val('order');" class="btn btn-blue">바로구매</button>
...
<!--				<button type="submit" onClick="$('#stype').val('wish');"class="btn btn-black">찜하기</button>-->
		...
		<div class="product-info mt10">
			<ul class="flexcenter info-nav2" id="itemtabmenu1">
				<li class="on"><a href="#itemtabmenu1">상품정보</a></li>
		...
		<div class="product-info mt10">
			<ul class="flexcenter info-nav2" id="itemtabmenu2">
				<li><a href="#itemtabmenu1">상품정보</a></li>
				<li class="on"><a href="#itemtabmenu2">사용후기 <span class="item_review_count"><?php echo number_format(element('cit_review_count', element('data', $view)));?></span></a></li>
				<li><a href="#itemtabmenu3">상품문의 <span class="item_qna_count"><?php echo number_format(element('cit_qna_count', element('data', $view)));?></span></a></li>
			</ul>
			<div id="viewitemreview"></div>
			<div class="buybtnbox">
				<a href="javascript:;" class="btn btn-blue2" onClick="window.open('<?php echo site_url('cmall/review_write/' . element('cit_id', element('data', $view))); ?>', 'review_popup', 'width=750,height=770,scrollbars=1'); return false;">사용후기 쓰기</a>
			</div>
		</div>
		<div class="product-info mt10">
			<ul class="flexcenter info-nav2" id="itemtabmenu3">
				<li><a href="#itemtabmenu1">상품정보</a></li>
				<li><a href="#itemtabmenu2">사용후기 <span class="item_review_count"><?php echo number_format(element('cit_review_count', element('data', $view)));?></span></a></li>
				<li class="on"><a href="#itemtabmenu3">상품문의 <span class="item_qna_count"><?php echo number_format(element('cit_qna_count', element('data', $view)));?></span></a></li>
			</ul>
			<div id="viewitemqna"></div>
			<div class="buybtnbox">
				<a href="javascript:;" class="btn btn-blue2" onClick="window.open('<?php echo site_url('cmall/qna_write/' . element('cit_id', element('data', $view))); ?>', 'qna_popup', 'width=750,height=770,scrollbars=1'); return false;">상품문의 쓰기</a>
			</div>
		</div>
